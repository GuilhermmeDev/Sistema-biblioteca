...
<div class="container">
  <form action="/store" method="POST">
    ...
    <div class="container_label">
      ...
      <input type="text" id="titulo" name="titulo" class="input" max="255">
      @error('titulo')
          <p>{{$message}}</p>
      @enderror
    </div>
    ...
    <div class="container_label">
      ...
      <input type="text" id="genero" name="genero" class="input" max="255">
      @error('genero')
          <p>{{$message}}</p>
      @enderror
    </div>
    ...
    <div class="container_label">
      ...
      <input type="text" id="autor" name="autor" class="input" max="255">
      @error('autor')
          <p>{{$message}}</p>
      @enderror
    </div>
    ...
    <div class="container_label">
      ...
      <textarea id="sinopse" name="sinopse" class="input textarea" maxlength="1000"></textarea>
      @error('sinopse')
          <p>{{$message}}</p>
      @enderror
    </div>
    ...
    <div class="container_label">
      ...
      <input type="number" id="avaliacao" name="avaliacao" min="0" max="5" step="0.1" class="input">
      @error('avaliacao')
          <p>{{$message}}</p>
      @enderror
    </div>
    ...
    <div class="container_label">
      ...
      <input type="number" id="ano_lancamento" name="ano_lancamento" class="input" min="0">
    ...
    <div class="container_label">
      ...
      <input type="number" min="0" id="num_exemplares" name="num_exemplares" class="input">
    ...
    <div class="container_label">
      ...
      <input type="number" min="1" id="num_paginas" name="num_paginas" class="input">
      @error('num_pag')
          <p>{{$message}}</p>
      @enderror
    </div>
    ...
    <div class="container_label">
      ...
      <input type="url" id="url_img" name="url_img" class="input">
      @error('urm_img')
          <p>{{$message}}</p>
      @enderror
