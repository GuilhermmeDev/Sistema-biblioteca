...
<body class="text-center">
    <div class="min-h-screen flex flex-col justify-center items-center">
        <header>
            <div class="logo mb-8">
                <img class="w-48" src="{{asset('imgs/LYBRIS.svg')}}" alt="Lybris Logo">
            </div>
            <nav class="mb-8">
                <button type="submit" class="nav-btn bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md w-1/2 sm:w-1/4 md:w-1/5 lg:w-1/6">
                    <a href="/login">Login</a>
                </button>
                <a href="/register" class="register_button">
                    <button type="submit" class="nav-btn cadastro bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md w-1/2 sm:w-1/4 md:w-1/5 lg:w-1/6">
                        Cadastre-se
                    </button>
                </a>
            </nav>
        ...
        <main class="text-center">
            <section class="intro mb-16">
                ...
                <h1>Aumente seu conhecimento com a&nbsp;<span class="highlight">Lybris</span></h1>
                ...
                <a href="/register" class="faca_parte">
                    <button type="submit" class="btn bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md w-1/2 sm:w-1/4 md:w-1/5 lg:w-1/6 mt-8">
                        Faça parte
                    </button>
                </a>
            </section>
